    ...
    <nav>
      ...
      {menuOpen && (
        <div className="nav-mobile-menu">
          ...
          <a href="https://api.leadconnectorhq.com/widget/bookings/corehoodcleaning" className="btn-primary" onClick={() => setMenuOpen(false)} style={{marginTop:'12px', 
textAlign:'center', display:'block'}}>Book a Free Quote</a>
        </div>
      )}
    </nav>
  )
