...
const REVIEWS = [
  ...
  { name: 'Cammy M.', role: 'Multi-Location Owner', text: "Chase is the man!!! I've been dealing with him for almost 3 years!! I now use him across 4 different locations! Fast and efficient work every single time. Definitely give him a call!!!" },
