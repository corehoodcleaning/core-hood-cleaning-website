          ...
          <div className="container" style={{ maxWidth: '760px' }}>
            ...
            <div style={{ borderTop: '1px solid var(--gray-light)', paddingTop: '32px', marginTop: '40px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                ...
                <Link href="/blog/commercial-kitchen-fire-suppression" style={{ fontSize: '0.9rem', color: 'var(--rust)', textDecoration: 'none' }}>→ How Your Hood Cleaning Affects Your Fire Suppression System</Link>
